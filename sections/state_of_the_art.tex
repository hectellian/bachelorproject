...
\begin{enumerate}
  ...
  \item
    ...
    \end{minted}
    \captionof{lstlisting}{Exploiting Speculative Execution via JavaScript.\cite{kocherSpectreAttacksExploiting2018}}
    ...
    \end{minted}
    \captionof{lstlisting}{Meltdown Attack Assembly Code.\cite{lippMeltdown2018}}
...
\item
  ...
  \begin{figure}[h]
    ...
    \begin{subfigure}{.33\textwidth}
      \centering
      \includegraphics[width=\linewidth]{decay1.png}
      \caption{Machine A and C Data}
    \end{subfigure}%
    \begin{subfigure}{.33\textwidth}
      \centering
      \includegraphics[width=\linewidth]{decay2.png}
      \caption{Machine B and F Data}
    \end{subfigure}
    \begin{subfigure}{.33\textwidth}
      \centering
      \includegraphics[width=\linewidth]{decay3.png}
...
\end{minted}
  \captionof{lstlisting}{Pseudocode for a cold boot attack scenario}
...
Developing specialized hardware that supports homomorphic encryption
